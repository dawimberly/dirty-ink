-- Seed script for public.shops (open-chair booking locations for /book)
-- Run after 001_create_shops.sql and 003_shop_locations_and_booking_fields.sql
-- Safe to re-run: skips rows when name already exists
